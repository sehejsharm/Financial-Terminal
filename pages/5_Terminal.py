...
if module == "Company Snapshot":
    ...
    st.caption(
        "Educational overview generated by Gemini — general knowledge, "
        "not sourced market data. Results are cached for 12 hours so "
        "re-opening the same ticker costs no extra API calls."
    )
